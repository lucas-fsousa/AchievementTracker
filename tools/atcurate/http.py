...
Identico em espirito ao mtcurate/http.py do MountTracker.
"""
...
DEFAULT_UA = ("AchievementTracker-curate/0.1 (community addon; "
              "https://github.com/lucas-fsousa/AchievementTracker)")
